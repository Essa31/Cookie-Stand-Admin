...
export default function CookieStandForm() {
  ...
  return (
    <>
    <div className='w-full max-w-screen-lg p-3 px-6 my-6 rounded-md bg-orange-400'>
        ...
        <form onSubmit={formHandler} className="my-5 rounded-md ">
            <div className="flex flex-wrap ">
                ...
                <div className="w-full px-3 mb-5">
                    ...
                    <input className="w-full px-6 py-3 text-gray-800 placeholder-black rounded bg-gray-50 h-1/2" id="Location" type="string" placeholder="Barcelona" required={true} />
                </div>
                ...
                <div className="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                    ...
                    <input className="w-full px-6 py-3 text-gray-800 placeholder-black rounded bg-gray-50 h-1/2" id="MinimumCustomersPerHour" type="text" placeholder="2" required={true} />
                </div>


                <div className="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                    <label className="text-sm font-bold tracking-wide text-gray-700">Maximum Customers Per Hour</label>
                    <input className="w-full px-6 py-3 text-gray-800 placeholder-black rounded bg-gray-50 h-1/2" id="MaximumCustomersPerHour" type="text" placeholder="4" required={true} />
                </div>
                
                <div className="w-full px-3 mb-6 md:w-1/4 md:mb-0">
                    <label className="text-sm font-bold tracking-wide text-gray-700">Average Cookies Per Hour</label>
                    <input className="w-full px-6 py-3 text-gray-800 rounded 0placeholder-black bg-gray-50 h-1/2" id="AverageCookiesPerHour" type="float" placeholder="2.5" required={true} />
                </div>

                <div className="mt-4 md:w-1/4 ">
                    <button type="submit" className="block w-full h-full font-bold bg-red-200 rounded-md bg-red-500">
                    Create
                    </button>
                </div>
